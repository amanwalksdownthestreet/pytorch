...
void initPlacementBindings(PyObject* module) {
  ...
  auto placement_cls = py::class_<Placement>(
      distributed_module,
      "Placement",
  ...
  auto shard_cls = py::class_<Shard, Placement>(
  ...
  auto strided_shard_cls = py::class_<StridedShard, Placement>(
  ...
  auto replicate_cls = py::class_<Replicate, Placement>(
  ...
  auto partial_cls = py::class_<Partial, Placement>(
